...
INSERT INTO users (cc, nombre, contrasena, rol, sede)
SELECT '12345678901112', 'DEV CALIDAD', '$2b$10$aqS2r2huodNAdiB1V5bSCOwPK26QurW.0ONVGcO1TjPfvrlgv6482', 'CALIDAD', 'BARRANQUILLA'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE cc = '12345678901112');
